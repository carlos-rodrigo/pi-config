...
- `semantic_search` — natural-language code search over a local index. Uses local Ollama embeddings by default, with lexical fallback. Returns ranked paths, line ranges, reasons, symbols, and compact previews.
...
- Combines Ollama embedding similarity, lexical terms, paths, symbols, lightweight vector scoring, and code-concept expansion.
